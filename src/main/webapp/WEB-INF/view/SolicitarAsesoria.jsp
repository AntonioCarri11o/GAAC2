...
<div class="lesscontainer">
  <div class="container-fluid scont">
    ...
    <c:out value="${nameCarrera}"/>
    <c:forEach items="${listM}" var="materia">
      <form action="newAdvisory" method="get">
        <input type="text" hidden name="materia" value="${materia.id}">
        <button type="submit" class="btn btn-primary"><c:out value="${materia.name}"/></button>
      </form>
